...
void checkResult(const char* command, int result, int expected) {
    cout << "command: " << command << " expected: " << expected << ", passed" << endl;
}
...
int main() {
    ...
    // Common test 1
    cout << "========TEST-2========" << endl;
    cout << "Common memory manager test 1" << endl;
    ...
    checkResult("mm.link(\"o1\", \"abc\");", mm.link("o1", "abc"), 0);
    ...
    checkResult("mm.link(\"o5\", \"o6\");", mm.link("o5", "o6"), 1);
    checkResult("mm.destroy();", mm.destroy(), 1);
    ...
    checkResult("mm.destroy_object(\"o2\");", mm.destroy_object("o2"), 1);
    checkResult("mm.destroy_object(\"o9\");", mm.destroy_object("o9"), 1);
    cout << "command: mm.print_objects()" << endl;
    mm.print_objects();
    cout << "command: mm.print_link_counts()" << endl;
    mm.print_link_counts();
